...
app.use((req, res, next) => {
  ...
  res.setHeader("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.clarity.ms https://*.google-analytics.com blob: https://pagead2.googlesyndication.com https://*.googlesyndication.com https://googleads.g.doubleclick.net https://*.doubleclick.net https://*.google.com https://tpc.googlesyndication.com https://*.adtrafficquality.google https://ep2.adtrafficquality.google https://cdn.jsdelivr.net https://clerk.doppelganger.world https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://res.cloudinary.com https://images.clerk-cdn.com https://img.clerk.com https://images.clerk.dev https://*.clerk.com https://*.clerk.dev https://www.clarity.ms https://*.google-analytics.com https://pagead2.googlesyndication.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google.com https://www.googletagmanager.com https://clerk.doppelganger.world https://*.adtrafficquality.google https://ep1.adtrafficquality.google; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://api.groq.com https://api.groq.com/openai/v1/chat/completions https://clerk.accounts.dev https://api.clerk.accounts.dev https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://clerk.doppelganger.world https://r.clarity.ms https://*.google-analytics.com https://*.analytics.google.com https://pagead2.googlesyndication.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google.com https://*.adtrafficquality.google https://ep1.adtrafficquality.google; frame-src 'self' https://clerk.doppelganger.world https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://googleads.g.doubleclick.net https://*.doubleclick.net https://*.google.com https://*.googlesyndication.com https://*.adtrafficquality.google https://ep2.adtrafficquality.google;");
